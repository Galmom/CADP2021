...
type
	...
	cant_localidad, cant_escuela, max1, max2, cantalumnos:integer;
	...
	begin
		...
		while (presentaciones.codigo <> -1) do begin
			...
			while (presentaciones.codigo <> -1) and (actual = presentaciones.localidad) do begin{localidad}
				...
				cantalumnos:=cantalumnos+presentaciones.cant_alumnos;
					...
					maximo(presentaciones.cant_alumnos, presentaciones.nombre_escue, max1, max2, nom1, nom2);
